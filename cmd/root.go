...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.recmd-cli.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".recmd-cli" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".recmd-cli")
	}
